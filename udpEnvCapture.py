    ...
    try:
        while True:
            ...
            if not queue.empty():
                ...
                # Move the current_time assignment here
                current_time = datetime.datetime.now().strftime("%d/%m/%Y %H:%M:%S")

                # Corrected function call with three parameters
                storeFileFB.push_image(file_loc, current_time, frame)
            ...
            current_time = datetime.datetime.now().strftime("%d/%m/%Y %H:%M:%S")  # Move the assignment here
            sensor_data = {
            ...
            # Corrected function call with three parameters
            storeFileFB.push_sensor_data('./sensor_data/all_data.json', current_time, frame)
